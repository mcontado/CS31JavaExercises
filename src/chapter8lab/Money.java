...
public class Money {
	...
	/**
	 * Adds the calling Money object to the parameter Money object. @param
	 * otherAmount the amount of money to add
	 * 
	 ...
	 * 
	 * @param amount
	 *            the amount of money to compare against @return -1 if the
	 *            dollars and the cents of the calling object are less than the
	 *            dollars and the cents of the parameter object, 0 if the
	 *            dollars and the cents of the calling object are equal to the
	 *            dollars and cents of the parameter object, and 1 if the
	 *            dollars and the cents of the calling object are more than the
	 *            dollars and the cents of the parameter object.
	 */
	...
	//Compares instance variables of the calling object with the instance
	// variables of the parameter object for equality
	// and returns true if the dollars and the cents of the calling object are the same as the
	// dollars and the cents of the parameter object.
