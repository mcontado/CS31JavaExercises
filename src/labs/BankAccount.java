...
public abstract class BankAccount {
	...
	/**
	 * copy constructor creates another account for the same owner @param
	 * oldAccount the account with information to copy @param the beginning
	 ...
	 * available,returns true if the transaction was completed, returns false if
	 * the there was not enough money. @param amount the amount to withdraw from
	 * the account @return true if there was sufficient funds to complete the
